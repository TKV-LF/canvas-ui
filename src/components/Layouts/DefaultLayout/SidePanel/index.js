...
const Sidebar = () => {
	...
	return (
		<div className={`flex flex-col items-center h-screen bg-gray-100 text-gray-700 shadow-lg ${open ? "w-[12rem]" : "w-20"} relative duration-200`}>
			...
			<div className={`flex flex-col items-center h-full w-full px-2 pb-5 mt-3 overflow-hidden`}>
				<div className="w-full px-2">
					<div className="flex flex-col items-center w-full mt-3 ">
						<a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="#">
							...
							<span className={`ml-2 text-sm font-medium ${!open && "scale-0"}`}>Dashboard</span>
						</a>

					</div>
					<div className={`flex flex-col items-center w-full mt-2 ${open && "border-t border-gray-300"}`}>
						<a className={`flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300`} href="#">
							<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
							</svg>
							<span className={`ml-2 text-sm font-medium ${!open && "scale-0"}`}>Products</span>
						</a>
			...
			<div className={`flex items-center w-full px-2 pb-5 -mb-5`}>
				<div className='inline-flex'>
					<img className={`bg-amber-300 rounded cursor-pointer block float-left duration-300`}  src="https://www.w3schools.com/howto/img_avatar.png" alt="ThuyLoi" width="36" height="36" />
